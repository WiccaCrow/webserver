...
ErrorResponses::ErrorResponses() {
    ...
    _errorResponses.insert(std::make_pair(HTTP::PROXY_AUTHENTICATION_REQUIRED,
        HTML_BEG HEAD_BEG TITLE_BEG + statusLines[PROXY_AUTHENTICATION_REQUIRED] + TITLE_END HEAD_END
        BODY_BEG H1_CENTER_BEG B_BEG + statusLines[PROXY_AUTHENTICATION_REQUIRED] + B_END H1_CENTER_END HR BODY_END HTML_END));
